...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
      ...
      <a href="/transaksi"><i class="fas fa-exchange-alt"></i> Kelola Transaksi</a>
      <a href="#" class="active"><i class="fas fa-comments"></i> Daftar Feedback</a>
    </nav>
  ...
  <div id="root" class="main-content">
    <!-- Hapus nav lama, karena sudah di sidebar -->
